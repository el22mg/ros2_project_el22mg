...
class ProjectSoln(Node):
    ...
    def callback(self, data):
        ...
        # Obtain image centre (480)
        height, width = image.shape[:2]
        self.imageCentreX = width // 2
        ...
        if len(blueContours)>0:
            ...
            self.blueAcrossPos = -1 # Flag there being no blue contour on screen in across-pos attribute by setting negative
    ...
    def centreBlueCube(self):
        ...
        while (abs(blueCubeCentreOffsetRight) > 30 and blueCubeCentreOffsetRight != -1):
            ...
            # Check position of blue cube on screen again
            blueCubeCentreOffsetRight = self.blueAcrossPos - self.imageCentreX
            self.get_logger().info(f'BlueCubeCentreOffsetRight: {blueCubeCentreOffsetRight}')
